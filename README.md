[![Netlify Status](https://api.netlify.com/api/v1/badges/a9f0f6cd-9dc2-44c1-baa1-98f288904d6b/deploy-status)](https://app.netlify.com/sites/web3land/deploys)

# Web3 Landscape

![Web3 Landscape Logo](https://img.freepik.com/free-vector/nature-scene-with-river-hills-forest-mountain-landscape-flat-cartoon-style-illustration_1150-37326.jpg?size=626&ext=jpg)

- [Web3 Landscape](#cloud-native-landscape)
...
This landscape is intended as a map to explore projects in the Web3 and Crypto domains. It is modelled after the Cloud Native Computing Foundation (CNCF) [landscape](https://landscape.cncf.io) and based on the same open source code. 

## Current Version

[![Web3 Landscape](https://web3land.org/images/landscape.png)](https://web3land.org/images/landscape.png)

## Interactive Version

Please see [web3land.org](https://web3land.org).
...
You can also use the helper script [edit_landscape.py](edit_landscape.py) in order to add/delete new projects easily.
example usage:

`python edit_landscape.py --action add --category defi --subcategory dex --name Uniswap --project-url https://uniswap.com --repo-url https://github.com/Uniswap/v3-core --logo-path uniswap-logo.svg`
